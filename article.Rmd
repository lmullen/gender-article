...
Examples like the Pulitzer and Bancroft Prizes are only the most glaring cases of gender inequity in the historical profession. Overt discrimination still exists, but inequity operates in ways that are far more cloaked and far more complex, which frequently makes them difficult to recognize or remedy. They take the form of subconscious bias that subtly weakens the assessment of work done by female historians. Gender discrimination frequently intersects with other kinds of racial and socioeconomic inequity [Townsend 2008]. And larger societal structures impede the professional lives of women: a 2011 survey by the American Historical Association revealed that female historians dedicated substantially more time to child and elder care than their male colleagues, leaving them with less time for research [Townsend 2012]. All of these factors combine and amplify each other to contribute to the gender gap in the historical profession on display in the pages of the *American Historical Review*.

The hidden, murky, and systemic dimensions of gender inequity makes methods like the Gender package all the more imperative. Our program was able to infer the genders of tens of thousands of authors, aggregate and chart their trajectory over time, and compare the pattern to another dataset of dissertation authors. Doing so revealed an unmistakable gap in the number of women who were getting reviewed by teh *American Historical Review*. But our program was able to look at subtler patterns - the kind that make gender inequity so insidious. After inferring the gender of book authors reviewed by the *AHR*, we were also able to infer the gender of the reviewers themselves. The story is much the same for reviewers as it is for authors: more than twice as many men as women appear as reviewers in the journal. But gender also inflects book reviews by shaping who writes reviews of which authors. About three times as many men write reviews of male-authored books as do women. In the case of female-authored books the ratio of female-to-male reviewers is closer to 50/50. In short, women are far more likely to write reviews of other women, while men tend to gravitate more towards male authors – who are, of course, already over-represented in the *AHR*.
...
Gender inequity is not always an overt case of deciding to award a prestigious prize to a male historian; it can be as subtle as deciding to write a book review of a male author. Countless individual actions like these constitute the relationships that knit together the field of academic history. And too often these tiny actions benefit men more than women: chairing a panel of mostly male historians, taking on a new male advisee, or assigning mostly male-authored books on a syllabus. On their own they might appear benign - one might argue that male historians simply happen to be interested in similar research topics - but in aggregate they contribute to a broader professional landscape that puts female historians at a disadvantage.

One 2013 analysis of 2,500 recent history Ph.D.'s found that "gender played little role in employment patterns across particular professions and industries" [Wood and Townsend 2013]. Our own analysis reveals a different story in terms of getting a book reviewed in the field's most prestigious journal. The *American Historical Review* continues to publish twice as many reviews of male-authored books as female-authored books. This disparity is put into even sharper relief when set against the much smaller gender gap in history dissertations. Women might be getting hired at comparable rates to men, but discriminatory gatekeeping remains alive and well in the profession.
 
### Conclusion
 
Include in conclusion
- gender is a tool that humanities scholars can put all of their tremendous skills in contextualizing, reocgnizing subtlety, and putting it in conversation with other sturctural power of race class and sexuality.
- Point to examples of how much it's downloaded, Ted Underwood, and especially Ben Schmidt's student evaluations, which is exactly the kind of ways it can be used to shed light on hidden patterns of systemic bias and discrimination.
