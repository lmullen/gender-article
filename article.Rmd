...
```{r, echo=FALSE}
editors <- data_frame(name = c("Madison", "Madison", "Morgan",
                                  "Morgan", "Jan", "Jan"),
...
The simplest way to use the package would be to call the `gender()` function, specifying the method, in this case the Social Security Administration dataset since all the names are after 1930, and specify the range of years in the dataset. However, using 

^[See the [package vignette](https://cran.rstudio.com/web/packages/gender/vignettes/predicting-gender.html) for more details about how to use the package effectively, including suggestions about performance: `vignette("predicting-gender", package = "gender")`.]
