...
Many other American names, such as Madison, Morgan, Sydney, and Kendall, have also changed gender over the past century. Such changes usually follow set patterns. In general, names tend to shift from being predominantly male to being predominantly female; the shift rarely moves in the other direction. In general, names that transition from male to female also became increasingly popular over time. For example, the name "Madison" changed from male to female suddenly after 1985. Whereas before it had been an infrequently used male name, after 1985 it skyrocketed in popularity, and by the early 2000s it was one of the ten most frequent names for baby girls. Broadly speaking, since the late twentieth century Americans girls are more likely than American boys to receive a "trendy" name, and once that name is associated with females it is unlikely to be given to male babies. The few exceptions of names which go from being female to male (such as "Jan") have a different causal mechanism. It seems likely that Jan as an English name is female but that Jan as a Scandinavian name is male. Because the name has remained relatively uncommon, other causes besides changing gender preferences can explain the change. **this last bit about "Jan" might just muddle things - unless we have a clear explanation or hypothesis as to what does explain the change, not sure it's worth highlighting**
