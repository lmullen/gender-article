...
To that end we have created the [Gender](https://github.com/ropensci/gender) package for R which contains the , and an associated [genderdata](https://github.com/lmullen/gender-data-pkg) package which contains various historical datasets.
